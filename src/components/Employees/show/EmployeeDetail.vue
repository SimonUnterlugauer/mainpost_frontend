<template>
  <div class="bg-white">
    <div class="mx-auto max-w-7xl px-6 text-center lg:px-8">
        <ul role="list" class="mx-auto mt-20 grid max-w-2xl grid-cols-1 gap-x-8 gap-y-16 sm:grid-cols-1 lg:mx-0 lg:max-w-none">
        <li>
            ...
            <h3 class="mt-6 text-base font-semibold leading-7 tracking-tight text-gray-900">{{ employee.name }}</h3>
            <p class="text-sm leading-6 text-gray-600">{{employee.abteilung}}</p>
